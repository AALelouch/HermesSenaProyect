  ...
  <div class="container-fluid collapse navbar-collapse" id="navbarSupportedContent">
    <ul class="navbar-nav me-auto mb-2 mb-lg-0 row">
      ...
      <li class="nav-item col">
        <a class="nav-link" href="conocenos" id="conocenos"><i class="bi bi-person-circle icon" roll="img"></i>
          Conocenos</a>
      </li>
      <li class="nav-item col">
        <a class="nav-link" href="catalogue" id="catalogo"><i class="bi bi-bag-check" roll="img"></i> Catalogo</a>
      </li>
      <li class="nav-item col">
