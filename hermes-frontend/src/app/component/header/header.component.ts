  ...
  <div class="container-fluid collapse navbar-collapse" id="navbarSupportedContent">
    <ul class="navbar-nav me-auto mb-2 mb-lg-0 row">
      <li class="nav-item col" style="width: auto;">
        <a id="home" class="nav-link active" aria-current="page" href="/"><i class="bi-house-fill" roll="img"></i>
          Home</a>
      </li>
      <li class="nav-item col">
        <a class="nav-link" href="conocenos.html" id="conocenos"><i class="bi bi-person-circle icon" roll="img"></i>
          Conocenos</a>
      </li>
      <li class="nav-item col">
        <a class="nav-link" href="catalogo.html" id="catalogo"><i class="bi bi-bag-check" roll="img"></i> Catalogo</a>
      </li>
      <li class="nav-item col">
        <a style="padding: 15px;" class="nav-link" href="login"><i class="bi bi-person-square" roll="img"></i> Acceder</a>
      </li>
    </ul>
  </div>
</div>
